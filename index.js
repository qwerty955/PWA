...
fetch("https://kitsu.io/api/edge/"+ii+"?page[limit]=20")
.then(function (e){
    return e.json();
})
.then(function (e){
    for (let i =0;i<e.data.length;i++){
            ...
            a.setAttribute("href","https://kitsu.io/"+ii+"/"+e.data[i].attributes.slug)
            ul.appendChild(li)
            ul.appendChild(li2)
            ul.appendChild(li3)
            ul.appendChild(li4)
...
document.getElementById("fa").addEventListener("click",()=>{
    fetch("https://kitsu.io/api/edge/"+ii+"?page%5Blimit%5D=20&page%5Boffset%5D="+(las-1))
.then(function (e){
    return e.json();
})
.then(function (e){
    ...
    if (st!=""||st!=" "){
        ...
        .then(document.getElementById("fa2").addEventListener("click",()=>{
                for (let i =0;i<ge.included.length;i++){
                    ...
                    a.innerHTML='Watch for Kitsu.io';
                    a.setAttribute("target","_blank");
                    a.setAttribute("href","https://kitsu.io/"+ii+"/"+ge.included[i]?.attributes?.slug);
                    ul.appendChild(li);
                    ul.appendChild(li2);
                    ul.appendChild(li3);
                    ul.appendChild(li4);
